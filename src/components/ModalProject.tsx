...
export const ModalProject = ({selectedProject, setSelectedProject}: Props) => {
    ...
    >
        <div className="w-3/4 lg:w-2/3 xl:w-1/2 shadow-lg relative flex flex-col sm:flex-row"
            onClick={(e) => e.stopPropagation()}>
            <div className="flex-[1.5]">
                <img src={selectedProject.imageSrc} alt={selectedProject.name} 
        ...
        <button type="button" className="absolute top-6 right-6 cursor-pointer"
            onClick={() => setSelectedProject(null)}
        >
