...
export const Header = () => {
    ...
    const {photoSrc, name, contactEmail, location, occupation, overview, phoneNumber, socialLinks} = personalInfo
  ...
  return <>
    <div className="flex flex-col sm:flex-row gap-6 sm:gap-12">
        ...
        <div className="flex flex-col gap-3 flex-1">
            ...
            <div className="flex gap-2 mt-4">
                ...
                <button className="bg-sky-500 p-3 rounded-md cursor-pointer"
                    title="Copiar email"
    ...
    {isActiveNotification && (
        <div className="bg-green-500 rounded-md absolute bottom-4 right-4 p-3 shadow-lg 
